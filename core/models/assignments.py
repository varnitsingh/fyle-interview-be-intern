...
class Assignment(db.Model):
    ...
    @classmethod
    def grade_assignment_by_teacher(cls,_id,grade,principal:Principal):
        assignment = Assignment.get_by_id(_id)
        assertions.assert_found(assignment, 'No assignment with this id was found')
        ...
        assertions.assert_valid_grade(grade in set(item.value for item in GradeEnum), "Grade not available in enum")
